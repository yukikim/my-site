...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_categories_type" AS ENUM('post', 'work', 'common');
  ...
  CREATE TABLE "categories_sessions" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"created_at" timestamp(3) with time zone,
  ...
  CREATE TABLE "categories" (
  	...
  	"description" varchar,
  	"type" "enum_categories_type" DEFAULT 'common',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"email" varchar NOT NULL,
  	"reset_password_token" varchar,
  ...
  ALTER TABLE "categories_sessions" ADD CONSTRAINT "categories_sessions_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "categories_sessions_order_idx" ON "categories_sessions" USING btree ("_order");
  CREATE INDEX "categories_sessions_parent_id_idx" ON "categories_sessions" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "categories_slug_idx" ON "categories" USING btree ("slug");
  CREATE INDEX "categories_updated_at_idx" ON "categories" USING btree ("updated_at");
  CREATE INDEX "categories_created_at_idx" ON "categories" USING btree ("created_at");
  CREATE UNIQUE INDEX "categories_email_idx" ON "categories" USING btree ("email");
  ...
  CREATE INDEX "payload_preferences_rels_categories_id_idx" ON "payload_preferences_rels" USING btree ("categories_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "categories_sessions" CASCADE;
